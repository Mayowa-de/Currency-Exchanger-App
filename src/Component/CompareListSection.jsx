...
export default function CompareListSection({ baseCurrency, options, favoriteActions }) {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-[2px] rounded-[16px] border-none bg-[#202022] p-[8px] px-[8px]' role='tabpanel' aria-labelledby='compare-tab'>
