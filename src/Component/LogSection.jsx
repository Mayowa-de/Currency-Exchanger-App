      ...
      {conversionLogs.length === 0 ? (
        ...
        <ul className='mt-[12px] flex flex-col gap-[8px]'>
          {conversionLogs.map((log) => (
            <li key={log.id} className='flex items-center justify-between gap-[12px] rounded-[12px] border border-neutral-700 bg-[#2E2E2E] p-[12px]'>
              <div className='flex flex-col min-w-0 flex-1 items-start gap-[10px]'>
                ...
                <div className='min-w-0 flex ml-8'>
              ...
              <div className='flex shrink-0 flex-col items-end gap-[6px]'>
                ...
                <time dateTime={log.createdAt} className='text-right text-[10px] text-neutral-500'>{formatDate(log.createdAt)}</time>
              </div>
            </li>
          ))}
        </ul>
